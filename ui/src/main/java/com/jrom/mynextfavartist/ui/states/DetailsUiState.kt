...
/**
 * Unlike PlanetFinder's DetailsUiState (isFavorite + a single shared BaseUiState used only
 * for the favorite-toggle's loading/error), this screen has two independent async concerns:
